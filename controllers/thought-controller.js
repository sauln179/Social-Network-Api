 { User, Thought, Reaction } = require('../models');
...
const thoughtController = {
    ...
    // POST /api/thoughts/:id/reactions
     // expected body should include the following attributes:
    // {
    //     "reactionBody": "baz"  // should be a reactionId in the specified Thought instance
    //     "username": "Giga"
    //     "userId": "[id here without brackets]" //should be a users unique id.
    // }
